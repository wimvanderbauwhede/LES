module module_vel2_init

contains

      subroutine vel2_init(km,jm,im,nou1,u,diu1,dx1,nou5,v,diu5,dy1,nou9,w,diu9,dzn,cov1,cov5,cov9,nou2, &
...
! 
      ...
      do i = 1,im
        ...
        diu1(i,j,k) = (-u(i-1,j,k) + u(i,j,k) )/dx1(i) ! WV: THis is the offending line, it's the access to u(i-1,j,k) that causes undefined values
